...
namespace Gtk {
	...
	public class Range : Gtk.Widget, Atk.Implementor, Gtk.Buildable, Gtk.Orientable {
		...
		[NoWrapper]
		public virtual void get_range_border (out Gtk.Border border_);
		public void get_range_rect (out Gdk.Rectangle range_rect);
	...
	public class Style : GLib.Object {
		...
		public GLib.Value get_style_property (GLib.Type widget_type, string property_name);
	...
	public class StyleContext : GLib.Object {
		...
		public void get_background_color (Gtk.StateFlags state, out Gdk.RGBA color);
		public void get_border (Gtk.StateFlags state, out Gtk.Border border);
		public void get_border_color (Gtk.StateFlags state, out Gdk.RGBA color);
		public void get_color (Gtk.StateFlags state, out Gdk.RGBA color);
		public Gtk.TextDirection get_direction ();
		public unowned Pango.FontDescription get_font (Gtk.StateFlags state);
		public Gtk.JunctionSides get_junction_sides ();
		public void get_margin (Gtk.StateFlags state, out Gtk.Border margin);
		public void get_padding (Gtk.StateFlags state, out Gtk.Border padding);
