...
namespace Gedit {
	...
	public class Document : Gtk.SourceBuffer {
		...
		public signal void saved(void *error);
		public signal void loaded(void *error);
	}
	...
	public class Window : Gtk.Window {
		...
		public signal void tab_added(Gedit.Tab tab);
		public signal void tab_removed(Gedit.Tab tab);
		public signal void tabs_reordered();
		public signal void active_tab_changed(Gedit.Tab tab);
		public signal void active_tab_state_changed();
	}
